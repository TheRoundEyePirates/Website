    ...
    <section id="crew" className="mx-auto max-w-5xl scroll-mt-24 px-6 py-24 sm:py-32">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        <div
          ...
          className="card-3d card-magnetic rounded-3xl border border-ink/25 bg-card p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_14px_28px_-14px_rgba(0,0,0,0.6)] sm:p-8"
        >
