...
export default function Hero() {
  return (
    ...
    >
      <div data-hero-scrub className="flex flex-col items-center">
        {/* Compass instrument */}
        <div
          data-animate="scale"
          className="relative mb-8 flex h-64 w-64 items-center justify-center"
        >
          <div data-parallax="0.3" className="absolute inset-0 flex items-center justify-center">
        ...
        <p
          ...
          data-delay="0.1"
          className="font-mono text-xs uppercase tracking-[0.4em] text-navy sm:text-sm"
        >
          FTC 37060
        </p>
        ...
        <p data-animate="fade-in" data-delay="0.3" className="mt-6 font-mono text-sm text-ink/70">
          Charting course since July 26, 2026.
        </p>

        <hr data-animate="fade-in" data-delay="0.4" className="mt-10 w-24 border-ink/30" />
      </div>
